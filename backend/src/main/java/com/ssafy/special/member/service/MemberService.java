...
import com.ssafy.special.crew.dto.response.FriendListDto;
import com.ssafy.special.member.dto.request.UserTasteDto;
import com.ssafy.special.member.dto.request.UserInfoUpdateDto;
import com.ssafy.special.food.dto.response.RecentFoodDto;
import com.ssafy.special.member.dto.response.HomeDto;
import com.ssafy.special.member.dto.response.MemberDetailDto;
import com.ssafy.special.member.dto.response.MemberInfoDto;
import com.ssafy.special.member.dto.response.TypeRateDto;
import com.ssafy.special.security.dto.request.UserSignUpDto;
...
import com.ssafy.special.food.repository.IngredientRepository;
import com.ssafy.special.member.repository.*;
...
//    private String region;
    ...
    public void signUp(UserSignUpDto userSignUpDto) throws DuplicateEmailException, DuplicateNicknameException, SignupFailedException {
        ...
        try {
            ...
            addInitialFoods(userSignUpDto, member);
    ...
    private void addInitialFoods(UserSignUpDto userSignUpDto, Member member) {
        addFavoriteFoods(userSignUpDto, member);

        addHateFoods(userSignUpDto, member);

        addAllergyFoods(userSignUpDto, member);
    }

    private void addAllergyFoods(UserSignUpDto userSignUpDto, Member member) {
    ...
    private void addHateFoods(UserSignUpDto userSignUpDto, Member member) {
    ...
    private void addFavoriteFoods(UserSignUpDto userSignUpDto, Member member) {
...
//            log.info(String.valueOf(member.getFoodPreferences().size()));
            if(member.getFoodPreferences() != null) {
